...
<img align="right" src="https://github.com/DerekPascarella/TeamInnocent-EnglishPatchPCFX/blob/main/images/about_the_game.png?raw=true">"Team Innocent: The Point of No Return - G.C.P.O.SS" is a thrilling blend of adventure and action, offering players three distinct missions to conquer. Step into the shoes of Saki, the primary heroine, while occasionally taking control of another brave young woman during pivotal moments. As the story unfolds, you'll explore diverse, intricately designed locations, gathering essential items, solving clever puzzles, and wielding an array of weapons ranging from pistols to axes.
<br><br>
Choose your combat style from four dynamic modes: punching, kicking, shooting, and, in specific scenarios, jumping. The gameplay is presented from a third-person perspective, set against atmospheric, pre-rendered backgrounds with cinematic, constantly shifting camera angles reminiscent of "Alone in the Dark." However, the protagonists are depicted as charmingly detailed sprites, giving the game a unique visual style. Anime-inspired cutscenes and fully voiced dialogues further immerse players in this captivating adventure.
