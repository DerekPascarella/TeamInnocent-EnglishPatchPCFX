...
<br><br>
The latest version of this patch is <a href="https://github.com/DerekPascarella/TeamInnocent-EnglishPatchPCFX/releases/download/0.9.1/Team.Innocent.-.The.Point.of.No.Return.-.G.C.P.O.SS.English.v0.9.1.zip">0.9.1</a>.
...
<ul>
 <li><b>Version 0.9.1 (2025-02-12)</b></li>
 <ul>
  <li>All dialogue text is now timed to be synchronized with voice acting and lip movements.</li>
  <li>Saki's name plate in the Status menu now appears in English.</li>
 </ul>
...
<img align="right" src="https://github.com/DerekPascarella/TeamInnocent-EnglishPatchPCFX/blob/main/images/about_the_game.png?raw=true">"Team Innocent: The Point of No Return - G.C.P.O.SS" is a thrilling blend of adventure and action, offering players three distinct missions to conquer. Step into the shoes of Saki, the primary heroine, while occasionally taking control of another brave young woman during pivotal moments. As the story unfolds, players will explore diverse, intricately designed locations, gathering essential items, solving clever puzzles, and wielding an array of weapons ranging from pistols to axes.
<br><br>
Players choose their combat style from four dynamic modes: punching, kicking, shooting, and, in specific scenarios, jumping. The gameplay is presented from a third-person perspective, set against atmospheric, pre-rendered backgrounds with cinematic, constantly shifting camera angles reminiscent of "Alone in the Dark." However, the protagonists are depicted as charmingly detailed sprites, giving the game a unique visual style. Anime-inspired cutscenes and fully voiced dialogues further immerse players in this captivating adventure.

<h2>Controls</h2>
<img align="right" width="260" src="https://github.com/DerekPascarella/TeamInnocent-EnglishPatchPCFX/blob/main/images/controls.png?raw=true"><ul>
...
As of version 0.9.1, this English translation patch has the following limitations.
<br><br>
<ul>
   <li>
